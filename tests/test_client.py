...
def mock_api_client():
    ...
    with patch("puppy_kit.client.ApiClient") as mock_client_class:
        mock_instance = Mock()
...
def mock_configuration():
    ...
    with patch("puppy_kit.client.Configuration") as mock_config_class:
        mock_instance = Mock()
...
class TestDatadogClient:
    ...
    @patch("puppy_kit.client.monitors_api.MonitorsApi")
    @patch("puppy_kit.client.metrics_api.MetricsApi")
    @patch("puppy_kit.client.events_api.EventsApi")
    @patch("puppy_kit.client.hosts_api.HostsApi")
    @patch("puppy_kit.client.tags_api.TagsApi")
    @patch("puppy_kit.client.logs_api.LogsApi")
...
class TestGetDatadogClient:
    ...
    @patch("puppy_kit.config.load_config")
    @patch("puppy_kit.client.DatadogClient")
