...
TRIAGE_UNSTABLE_OPS: set[str] = {
    ...
    "create_global_incident_handle", "delete_global_incident_handle",
    "list_global_incident_handles", "update_global_incident_handle",
    "get_global_incident_settings", "update_global_incident_settings",
    "create_incident", "delete_incident", "get_incident", "update_incident",
    "list_incidents", "search_incidents", "import_incident",
    "create_incident_attachment", "delete_incident_attachment",
    "list_incident_attachments", "update_incident_attachment",
    "create_incident_integration", "delete_incident_integration",
    "get_incident_integration", "list_incident_integrations",
    "update_incident_integration",
    "create_incident_notification_rule", "delete_incident_notification_rule",
    "get_incident_notification_rule", "list_incident_notification_rules",
    "update_incident_notification_rule",
    "create_incident_notification_template", "delete_incident_notification_template",
    "get_incident_notification_template", "list_incident_notification_templates",
    "update_incident_notification_template",
    "create_incident_postmortem_attachment",
    "create_incident_postmortem_template", "delete_incident_postmortem_template",
    "get_incident_postmortem_template", "list_incident_postmortem_templates",
    "update_incident_postmortem_template",
    "create_incident_todo", "delete_incident_todo", "get_incident_todo",
    "list_incident_todos", "update_incident_todo",
    "create_incident_type", "delete_incident_type", "get_incident_type",
    "list_incident_types", "update_incident_type",
    "create_incident_service", "delete_incident_service",
    "get_incident_service", "list_incident_services", "update_incident_service",
    "add_member_team", "create_incident_team", "delete_incident_team",
    "get_incident_team", "list_incident_teams", "list_member_teams",
    "remove_member_team", "update_incident_team",
    # Case management (triage linking)
    "create_case_jira_issue", "create_case_notebook",
    "create_case_service_now_ticket", "link_incident",
    "link_jira_issue_to_case", "move_case_to_project", "unlink_jira_issue",
    # Read-only triage ops
    "get_finding", "list_findings", "list_vulnerabilities", "list_vulnerable_assets",
    "list_scanned_assets_metadata", "get_rule_version_history",
    "get_secrets_rules", "get_security_monitoring_histsignal",
    "get_security_monitoring_histsignals_by_job_id",
    "list_security_monitoring_histsignals",
    "search_security_monitoring_histsignals",
    "list_threat_hunting_jobs", "get_threat_hunting_job",
    "list_scorecard_outcomes", "list_scorecard_rules",
    "list_scorecard_outcomes", "list_entity_risk_scores",
    "create_slo_report_job", "get_slo_report",
    "get_slo_report_job_status", "get_slo_status",
    "get_spa_recommendations", "get_spa_recommendations_with_shard",
    "get_code_coverage_branch_summary", "get_code_coverage_commit_summary",
    "search_flaky_tests",
    "list_llm_obs_datasets", "list_llm_obs_dataset_records",
    "list_llm_obs_experiments", "list_llm_obs_projects",
    "get_data_deletion_requests",
    "list_apis", "get_open_api",
    "list_role_templates",
    "list_restriction_queries", "get_restriction_query",
    "list_restriction_query_roles", "list_user_restriction_queries",
    "get_role_restriction_query",
    "list_monitor_user_templates", "get_monitor_user_template",
    "validate_existing_monitor_user_template", "validate_monitor_user_template",
    "list_connections", "get_mapping", "get_account_facet_info",
    "get_user_facet_info", "query_accounts", "query_event_filtered_users",
    "query_users",
    "list_jira_accounts", "list_jira_issue_templates", "get_jira_issue_template",
    "list_service_now_instances", "list_service_now_templates",
    "get_service_now_template", "list_service_now_assignment_groups",
    "list_service_now_business_services", "list_service_now_users",
    "get_tenancy_configs",
    "get_hamr_org_connection",
    "get_all_datasets", "get_dataset",
    "get_custom_rule", "get_custom_rule_revision", "get_custom_ruleset",
    "list_custom_rule_revisions",
    "get_fleet_agent_info", "list_fleet_agents", "list_fleet_agent_versions",
    "list_fleet_deployments", "get_fleet_deployment",
    "list_fleet_schedules", "get_fleet_schedule",
    "get_change_request",
    "get_deployment_gate", "get_deployment_gate_rules", "get_deployment_rule",
    "get_aws_cloud_auth_persona_mapping", "list_aws_cloud_auth_persona_mappings",
