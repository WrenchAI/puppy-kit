...
def create_slo(
    ...
    Examples:
        puppy_kit slo create --type metric --name "API SLO" --thresholds "30d:99.9" ...
        puppy_kit slo create -f slo.json
        puppy_kit slo export abc123 | puppy_kit slo create --from-stdin
    """
    if from_stdin:
